...
function isProbablyIngredientCondition(obj) {
	...
	return (obj.type === "origins:nbt" || obj.type === "origins:custom_data" || obj.type === "minecraft:custom_data" || obj.type === "apoli:custom_data" || obj.type === "custom_data" || obj.type === "apoli:nbt") && "nbt" in obj;
}
