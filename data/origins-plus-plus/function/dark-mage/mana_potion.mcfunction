...
give @s minecraft:potion[custom_data={tag:empty,display:{Name:'[{"translate":"origins-plus-plus.item.mana_potion","italic":false,"color":"dark_purple"}]',Lore:['[{"translate":"origins-plus-plus.item.mana_potion.capacity","italic":false}]']}}] 1
