...
give @s minecraft:potion[custom_data={empty:1b,display:{Name:'[{"translate":"origins-plus-plus.item.mana_potion","italic":false,"color":"dark_purple"}]',Lore:['[{"translate":"origins-plus-plus.item.mana_potion.capacity","italic":false}]']}}] 1
