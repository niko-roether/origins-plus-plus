give @s minecraft:written_book[written_book_content={pages:['{"translate":"origins-plus-plus.end-mage.book.welcome"}','{"translate":"origins-plus-plus.book.mana_potions"}','{"translate":"origins-plus-plus.end-mage.book.hidden_crafts"}','{"translate":"origins-plus-plus.end-mage.book.infinite_range"}','{"translate":"origins-plus-plus.end-mage.book.waypoint"}'],title:"Hidden Knowledge",author:"End Mage"}]
