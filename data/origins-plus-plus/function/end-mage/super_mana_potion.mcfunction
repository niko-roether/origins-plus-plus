...
give @s minecraft:potion[custom_data={superempty:1b},custom_name='[{"translate":"origins-plus-plus.item.super_mana_potion","italic":false,"color":"dark_purple"}]',lore=['[{"translate":"origins-plus-plus.item.super_mana_potion.capacity","italic":false}]']] 1
